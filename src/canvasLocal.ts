...
export class CanvasLocal {
  ...
  paint() {
    ...
    let h: number[] = [27, 25, 23, 20, 18, 17, 15, 13, 10, 8];
    let maxEsc: number;
    let colors: string[]= ['magenta', 'red', 'green', 'yellow', 'blue','pink', 'orange', 'brown ','red','purple'];
    ...
    for (let y = 0.6; y <= 6; y += 1.35){
      ...
      this.graphics.strokeText((maxEsc*i/5)+"",this.iX(-0.5), this.iY(y-0.7));
      i++;
    }
    this.graphics.strokeStyle = 'black';
    let ind = 0;
